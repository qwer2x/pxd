...
useradd -m -g users -G wheel -s /bin/bash adm2x
...
read -p "Пауза 3 ceк." -t 3
sudo pacman -S firefox screenfetch qt4 qbittorrent ufw gparted f2fs-tools dosfstools ntfs-3g alsa-lib alsa-utils gnome-calculator file-roller p7zip unrar gvfs aspell-ru pulseaudio
echo 'Установка тем'
read -p "Пауза 3 ceк." -t 3
